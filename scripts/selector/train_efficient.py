...
from drqa.efficient_selector import utils, vector, config, data
from drqa.efficient_selector import SentenceSelector
...
def add_train_args(parser):
    ...
    files.add_argument('--truncate-data', action="store_true", default=False)
