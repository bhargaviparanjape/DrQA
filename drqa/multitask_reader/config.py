...
MODEL_ARCHITECTURE = {
    ...
    'use_qemb', 'use_in_question', 'use_pos', 'use_ner', 'use_lemma', 'use_tf', 'sp_lambda',
...
def add_model_args(parser):
    ...
    model.add_argument("--sentence_selector_dump", type=str, default=None)
    ...
    model.add_argument("--sp-lambda", type=float, default=1.0)
    #####################################################################
